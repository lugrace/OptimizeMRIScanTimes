...
class unrolled_recon():
    ...
    def __init__(self,filepath=None):
        if filepath == None:
            filepath = '/media/cineraid/davidyzeng/recon_pytorch_runs/20180726_2136/350000.ckpt'
...
class recon_env():
  ...
  def __init__(self, recon, reward, base_dir):
    ...
    data_file = '/media/cineraid/davidyzeng/unroll_data_raw/pytorch_data.h5'
  ...
  def step(self, action):
    ...
    if done: #qqq
        self.total_done += 1
        np.save('/home/davidyzeng/dopamine/dopamine/recon_env/cs_l2_order.npy',self.line_order.astype(int))
        np.save('/home/davidyzeng/dopamine/dopamine/recon_env/cs_l2_reward.npy',self.reward_order)
